...
Upun closer examination the creation of aggregate results closely parallels the
creation of validation results. From an abstract point of view both 
types of results are created by event where an expression is evaluated
...
in a little more detail. Next, the metadata elements will be specified towars
