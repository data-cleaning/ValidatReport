...
(Definition~\ref{def:confrontation}). 
...
receiver of the report (e.g. in the case of a query statement, the 
specific version of a dataset should be identified as well).
