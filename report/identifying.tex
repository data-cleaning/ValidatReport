...
A validation event is a triple $(t,r,d)$, where $t$ identifies the
...
\end{definition}
%
We leave open the possibility that any of the components $t$, $r$ and $d$
consist of informative tuples to identify subcomponents of the event, data or
rule.  Note that the above `definition' is not a definition in the mathematical
sense.  Rather it is a convention that can be tested in a (software)
environment where data, rules, and validation events have been labeled and
stored.
